    ...
    groupList(group){
      switch (group){
        case 0:
          ...
          this.functionList.push(functionItem,functionItem1,functionItem2,functionItem3,functionItem4,functionItem5,functionItem6,functionItem7,functionItem8,functionItem9);
          break;
         case 1:
          var functionItem = {};
          functionItem['className'] = 'icon-usergroup';
